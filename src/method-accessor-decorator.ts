...
function accessorDecorator(
  ...
  const greeterMessagePropertyDescriptor = Reflect.getOwnPropertyDescriptor(
    target,
    propertyKey
  ) as PropertyDescriptor;
  assert(
    greeterMessagePropertyDescriptor.get === descriptor.get &&
      greeterMessagePropertyDescriptor.set === descriptor.set
  );
